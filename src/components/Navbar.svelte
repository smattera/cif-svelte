<div class="navbar bg-navbar fixed z-10 drop-shadow-2xl">
  <div class="navbar-start">
    <label for="my-drawer" class="btn btn-ghost border border-neutral bg-base-100 text-white transition ease-in-out delay-150 hover:scale-110 duration-300">
