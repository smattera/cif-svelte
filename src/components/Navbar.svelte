<div class="navbar bg-base-100 fixed z-10 drop-shadow-2xl">
  ...
  <div class="navbar-end">
    <a href="/" class="btn glass outline outline-neutral text-white transition ease-in-out delay-150 hover:scale-110 duration-300 mr-3">
