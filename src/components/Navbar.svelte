<div class="navbar bg-base-100 fixed z-10 drop-shadow-2xl">
  ...
  <div class="navbar-end">
    <a href="/" class="btn btn-warning btn-countdown transition ease-in-out delay-150 hover:scale-110 duration-300 mr-3">
      ...
      <span class="hidden ml-2 normal-case md:block">Buy Tickets</span>
    </a>
  </div>
</div>
